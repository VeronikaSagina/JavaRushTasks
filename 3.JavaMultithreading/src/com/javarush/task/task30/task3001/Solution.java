...
public class Solution {
    ...
    public static Number convertNumberToOtherNumerationSystem(Number number, NumerationSystem expectedNumerationSystem) {
        ...
        bigInteger = new BigInteger(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());
        int system = expectedNumerationSystem.getNumerationSystemIntValue();
        return new Number(expectedNumerationSystem, bigInteger.toString(system));
    }
}
